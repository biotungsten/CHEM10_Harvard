...
Most of the work you are doing in this class will happen in the form of jupyter notebooks. You can edit and run them either in your browser or in a dedicated IDE such as [VSCode](https://code.visualstudio.com). The latter will be especially useful if you plan on doing other development work. This guide assumes some basic familiarity with bash and using the terminal. If you are not familiar, we recommend a tutorial like [this](https://www.w3schools.com/bash/).
